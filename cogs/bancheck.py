...
SPREADSHEET_REGEX = re.compile(r"(https?:\/\/)?(www\.)?docs.google\.com\/spreadsheets(\/u\/0)?\/d\/(?P<id>[a-zA-Z0-9_-]+)")
...
class Spreadsheet:
    ...
    async def convert(cls,ctx,argument):
        ...
        if match:
            ...
            return endpoint
        return commands.BadArgument("That doesn't look like a valid roster link")
